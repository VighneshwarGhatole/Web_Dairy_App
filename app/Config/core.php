 ...
 */
	Configure::write('Security.salt', '248ca64cfe8898c9176b6615c7941de414bb4e98');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '653332663931363432636437363135');
...
$protocol = isset($_SERVER["HTTPS"]) ? 'http://' : 'http://';
$ur = $protocol.$_SERVER['HTTP_HOST'].'/dairy';
define('ABSOLUTE_URL',$ur.'/');

/* define('ICON_PATH','/var/www/html/release/app/webroot/icons/');
define('FOLDER_PATH','/var/www/html/release/app/webroot/common_folder/');
define('FILE_PATH','/var/www/html/release/app/webroot/files/'); */
