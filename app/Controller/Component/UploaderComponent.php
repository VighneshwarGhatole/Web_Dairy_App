 ...
 *  <li><b>{@link allowed}</b> array of allowed mime-types (or one string). wildcard accepted, as in image/* (default: check {@link initialize})<br>
 *  <pre>$handle->allowed = array('application/pdf','application/msword', 'image/*');</pre></li>
 *  <li><b>{@link forbidden}</b> array of forbidden mime-types (or one string). wildcard accepted, as in image/*  (default: check {@link initialize})<br>
 ...
 *   - initializeialise image_dst_x/y with image_src_x/y<br>
 ...
 *   - added support for Flash UploaderComponents<br>
 ...
 *   - added {@link image_reflection_opacity} to set the initializeial level of opacity of the reflection</li>
...
class UploaderComponent extends Component {
    ...
    /**
     * Set this variable to false in the initialize() function if you don't want to check the MIME 
    ...
    /**
     * Sets the initializeial opacity of the reflection
     *
    ...
    /**
     * initialize or re-initialize all the processing variables to their default values
     *
     ...
     */
    function createUploader($file, $lang = 'en_GB') {
        ...
        $this->translation['file_error'] = __('File error. Please try again.', true);
        $this->translation['local_file_missing'] = __('Local file doesn\'t exist.', true);
        $this->translation['local_file_not_readable'] = __('Local file is not readable.', true);
        $this->translation['uploaded_too_big_ini'] = __('File upload error (the uploaded file exceeds the upload_max_filesize directive in php.ini).', true);
        $this->translation['uploaded_too_big_html'] = __('File upload error (the uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the html form).', true);
        $this->translation['uploaded_partial'] = __('File upload error (the uploaded file was only partially uploaded).', true);
        $this->translation['uploaded_missing'] = __('File upload error (no file was uploaded).', true);
        $this->translation['uploaded_no_tmp_dir'] = __('File upload error (missing a temporary folder).', true);
        $this->translation['uploaded_cant_write'] = __('File upload error (failed to write file to disk).', true);
        $this->translation['uploaded_err_extension'] = __('File upload error (file upload stopped by extension).', true);
        $this->translation['uploaded_unknown'] = __('File upload error (unknown error code).', true);
        $this->translation['try_again'] = __('File upload error. Please try again.', true);
        $this->translation['file_too_big'] = __('File too big.', true);
        $this->translation['no_mime'] = __('MIME type can\'t be detected.', true);
        $this->translation['incorrect_file'] = __('Incorrect type of file.', true);
        $this->translation['image_too_wide'] = __('Image too wide.', true);
        $this->translation['image_too_narrow'] = __('Image too narrow.', true);
        $this->translation['image_too_high'] = __('Image too tall.', true);
        $this->translation['image_too_short'] = __('Image too short.', true);
        $this->translation['ratio_too_high'] = __('Image ratio too high (image too wide).', true);
        $this->translation['ratio_too_low'] = __('Image ratio too low (image too high).', true);
        $this->translation['too_many_pixels'] = __('Image has too many pixels.', true);
        $this->translation['not_enough_pixels'] = __('Image has not enough pixels.', true);
        $this->translation['file_not_uploaded'] = __('File not uploaded. Can\'t carry on a process.', true);
        $this->translation['already_exists'] = __('%s already exists. Please change the file name.', true);
        $this->translation['temp_file_missing'] = __('No correct temp source file. Can\'t carry on a process.', true);
        $this->translation['source_missing'] = __('No correct uploaded source file. Can\'t carry on a process.', true);
        $this->translation['destination_dir'] = __('Destination directory can\'t be created. Can\'t carry on a process.', true);
        $this->translation['destination_dir_missing'] = __('Destination directory doesn\'t exist. Can\'t carry on a process.', true);
        $this->translation['destination_path_not_dir'] = __('Destination path is not a directory. Can\'t carry on a process.', true);
        $this->translation['destination_dir_write'] = __('Destination directory can\'t be made writeable. Can\'t carry on a process.', true);
        $this->translation['destination_path_write'] = __('Destination path is not a writeable. Can\'t carry on a process.', true);
        $this->translation['temp_file'] = __('Can\'t create the temporary file. Can\'t carry on a process.', true);
        $this->translation['source_not_readable'] = __('Source file is not readable. Can\'t carry on a process.', true);
        $this->translation['no_create_support'] = __('No create from %s support.', true);
        $this->translation['create_error'] = __('Error in creating %s image from source.', true);
        $this->translation['source_invalid'] = __('Can\'t read image source. Not an image?.', true);
        $this->translation['gd_missing'] = __('GD doesn\'t seem to be present.', true);
        $this->translation['watermark_no_create_support'] = __('No create from %s support, can\'t read watermark.', true);
        $this->translation['watermark_create_error'] = __('No %s read support, can\'t create watermark.', true);
        $this->translation['watermark_invalid'] = __('Unknown image format, can\'t read watermark.', true);
        $this->translation['file_create'] = __('No %s create support.', true);
        $this->translation['no_conversion_type'] = __('No conversion type defined.', true);
        $this->translation['copy_failed'] = __('Error copying file on the server. copy() failed.', true);
        $this->translation['reading_failed'] = __('Error reading the file.', true);
